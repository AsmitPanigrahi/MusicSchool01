  ...
  <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      ...
      <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
        <div>
          ...
          <ul className="mt-2 space-y-2">
            <li>
              <a href="/" className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-200">Email</a>
            </li>
            <li>
              <a href="/" className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-200">Address</a>
            </li>
            <li>
              <a href="/" className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-200">Phone No</a>
            </li>
            <li>
              <a href="/" className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-200">Office</a>
            </li>
          </ul>
        </div>
        <div>
          <p className="font-medium tracking-wide text-gray-300">Courses</p>
          <ul className="mt-2 space-y-2">
            <li>
        ...
        <div>
          <p className="font-medium tracking-wide text-gray-300">Instructors</p>
          <ul className="mt-2 space-y-2">
            <li>
    ...
    <div className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row">
      <p className="text-sm text-gray-500">
        © Copyright 2024 Asmit Panigrahi. All rights reserved.
      </p>
